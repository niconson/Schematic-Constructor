...
#define FREENET "NET" 
#define OLD_NO_FP "???"
#define NO_FOOTPRINT "PART"
#define CSORT "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_/|\\"
#define SHORTCSORT "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
#define CP_SUFFIX		"|suffix:"
#define CP_LINK			"|LINK:"
#define CP_PAGE_NUM		"|page_number:"
...
class CFreeasyApp : public CWinApp
{
public:
	enum {
		PCB = 1,
...
public:
	...
	afx_msg void OnHelpUserGuidePdf2();
	afx_msg void OnHelpUserGuidePdf3();
};
