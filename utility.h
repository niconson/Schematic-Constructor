...
void MakeCStringFromDimension( double scale, CString * str, int dim, int units, BOOL append_units=TRUE, 
...
int TestPolygon( int xi, int yi, CPoint * P, int np, int * distance = NULL );
...
// import from 'Copper Areas Splitter'
	...
	int Generate_Dotted (int xi, int yi, int xf, int yf, CPoint * OutPut, int n_sides );
//
...
double Distance( int x1, int y1, int x2, int y2, BOOL bARC=FALSE );
...
///int FP_lay ( int pcb_lay );
///int Get_Side ( int lay );
